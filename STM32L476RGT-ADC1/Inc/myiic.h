...
//#define IIC_SDA_1 HAL_GPIO_WritePin(GPIOC,GPIO_PIN_8,GPIO_PIN_SET)		
//#define IIC_SDA_0 HAL_GPIO_WritePin(GPIOC,GPIO_PIN_8,GPIO_PIN_RESET)

//#define IIC_SCL_1 HAL_GPIO_WritePin(GPIOC,GPIO_PIN_6,GPIO_PIN_SET)
//#define IIC_SCL_0 HAL_GPIO_WritePin(GPIOC,GPIO_PIN_6,GPIO_PIN_RESET)

//#define READ_SDA	 HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_8)	
